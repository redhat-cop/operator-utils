...
func TestAdd(t *testing.T) {
	var e1, e2 lockedpatch.HashableLockedPatch
	e := createRandomObject(e1)
	if v, ok := e.(lockedpatch.HashableLockedPatch); ok {
		e1 = v
	}
...
func TestHas(t *testing.T) {
	var e1, e2, e3 lockedpatch.HashableLockedPatch
	e := createRandomObject(e1)
	if v, ok := e.(lockedpatch.HashableLockedPatch); ok {
		e1 = v
	}
...
func TestString(t *testing.T) {
	var e1 lockedpatch.HashableLockedPatch
	e := createRandomObject(e1)
	if v, ok := e.(lockedpatch.HashableLockedPatch); ok {
		e1 = v
	}
...
func TestEach(t *testing.T) {
	...
	found := make(map[lockedpatch.HashableLockedPatch]bool)

	s1.Each(func(item lockedpatch.HashableLockedPatch) bool {
		found[item] = true
		return true
	})
