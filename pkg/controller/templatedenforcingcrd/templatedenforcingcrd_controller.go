...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to secondary resource Pods and requeue the owner TemplatedEnforcingCRD
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &examplev1alpha1.TemplatedEnforcingCRD{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileTemplatedEnforcingCRD) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	lockedResources, err := lockedresource.GetLockedResourcesFromTemplates(instance.Spec.Templates, instance)
	if err != nil {
